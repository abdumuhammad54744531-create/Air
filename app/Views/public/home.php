...
<section class="portal-map-card portal-map-bottom">
  ...
  <div id="publicLocationsMap" data-selected="<?=$selectedLocationId?>" data-base-url="<?=e(url('publik'))?>" data-water-icon="<?=e(url('assets/images/as-air.ico'))?>" data-sync-url="<?=e(url('api/v1/public/locations'))?>" data-signature="<?=e($mapSyncSignature)?>" data-locations='<?=e(json_encode($locations))?>'></div>
</section>
</main>
