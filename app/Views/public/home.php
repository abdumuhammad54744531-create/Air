...
<section class="portal-map-card portal-map-bottom">
  <div class="portal-map-head"><div><h2><i class="bi bi-map-fill"></i> PETA LOKASI MATA AIR</h2><p>Pilih tampilan peta. Peta interaktif menyediakan Standar, Jalan, Satelit, Satelit + Label, Topografi, Light, dan Gelap.</p></div><div class="portal-map-actions"><div class="portal-map-legend"><span><i class="active"></i> Lokasi dipilih</span><span><i></i> Lokasi lainnya</span></div><div class="portal-map-switch" role="group" aria-label="Pilih tampilan peta"><button type="button" class="active" data-public-map-view="interactive"><i class="bi bi-geo-alt-fill"></i> Interaktif</button><button type="button" data-public-map-view="tableau"><i class="bi bi-bar-chart-map-fill"></i> Tableau</button></div></div></div>
  ...
  <div id="publicMapStage"><div id="publicLocationsMap" data-selected="<?=$selectedLocationId?>" data-base-url="<?=e(url('publik'))?>" data-water-icon="<?=e(url('assets/images/water-drop.png'))?>" data-sync-url="<?=e(url('api/v1/public/locations'))?>" data-signature="<?=e($mapSyncSignature)?>" data-locations='<?=e(json_encode($locations))?>'></div><div id="publicTableauMap" hidden><iframe title="Peta Tableau" src="https://public.tableau.com/shared/7CQRFKX9R?:showVizHome=no&amp;:embed=y" loading="lazy" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><p>Peta Tableau. Untuk melihat titik lokasi, popup, serta layer Satelit dan Topografi, pilih tampilan <b>Interaktif</b>.</p></div></div>
</section>
</main>
