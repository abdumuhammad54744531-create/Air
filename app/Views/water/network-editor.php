    ...
    <form class="modal-content" method="post" action="<?=url('distribution-networks/node')?>" id="networkNodeForm">
      ...
      <div class="modal-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6"><label class="form-label" for="networkNodeLinkedKey">Hubungkan dengan Data Master</label><select class="form-select" name="linked_key" id="networkNodeLinkedKey"><option value="">Belum dihubungkan</option><?php foreach($masterNodes as $node):?><option value="<?=e($node['key'])?>"><?=e($typeLabels[$node['type']].' · '.$node['name'])?></option><?php endforeach?></select><small class="form-text">Opsional; titik tetap dapat dipakai meskipun belum ada data master.</small></div>
